// OSMO "Button 004": parte cada copia del label en caracteres y setea las variables
// que el CSS usa para el flip 3D escalonado (--index = distancia al centro,
// --signed-index = lado/signo, --max-index = centro). La animación vive en el CSS.
