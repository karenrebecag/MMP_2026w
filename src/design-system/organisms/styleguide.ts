...
import { renderSection, renderContainer, renderGrid } from '../molecules/layout';
import { renderHeading, renderEyebrow, renderParagraph } from '../atoms/text';
      ...
      renderContainer({
        children: [
          block([
            ...
            renderParagraph({
              size: 'l',
              text: 'Paragraph L — texto introductorio de mayor jerarquía para subtítulos y leads.',
            }),
            renderParagraph({
              size: 'm',
              text: 'Paragraph M — cuerpo de texto estándar para descripciones y contenido general.',
            }),
          ]),
        ],
      }),
